...
def scroll_up_arrow():
    ...
    # scroll up by arrow
    driver.find_element(By.XPATH, value="//i[@class= 'fa fa-angle-up']").click()

    # verification
    engineers_title = driver.find_element(By.XPATH, value="//div[@id= 'slider-carousel']//div[@class  = 'col-sm-6']/h2").text
    print(engineers_title)
    assert engineers_title == "Full-Fledged practice website for Automation Engineers"
